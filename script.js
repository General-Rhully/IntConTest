...
notiFi = wrapper.querySelector(".notiFi"),
title = notiFi.querySelector("span"),
subTitle = notiFi.querySelector("p"),
wifiIcon = notiFi.querySelector(".icon"),
closeIcon = notiFi.querySelector(".close-icon");
...
window.onload = ()=>{
    function ajax(){
        ...
        xhr.onload = ()=>{ //once ajax loaded
            ...
            if(xhr.status == 200 && xhr.status < 300){
                notiFi.classList.remove("offline");
                ...
                setTimeout(()=>{ //hide the notiFi notification automatically after 5 seconds
                    wrapper.classList.add("hide");
                }, 650);
            }else{
    ...
    function offline(){ //function for offline
        ...
        notiFi.classList.add("offline");
        title.innerText = "You're offline now";
        subTitle.innerText = "Oh no! Internet is disconnected.";
